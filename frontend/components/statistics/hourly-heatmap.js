...
export default class HourlyHeatmap extends React.Component {
  static defaultProps = { dataset: [], duration: '7d', days: [] };

  drawHeatmap(timeframe="historic",duration=7) {
