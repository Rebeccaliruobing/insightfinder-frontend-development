...
export default class FilterBar extends Component {
  ...
  render() {
    const {
      projectName, incident, startTime, endTime,
      pvalue, cvalue, minPts, epsilon,
      projectType, modelType, modelTypeText, incidentList,
    ...
    const labelStyle = {};
    let self = this;
    if (!dashboardUservalues.projectString || !dashboardUservalues.incidentAllInfo) return (<div />);
    return (
      <div>
        <div className="ui pointing secondary menu" style={{ marginBottom: '24px', display: 'none' }}>
        ...
        <div className={cx('ui form', { loading: !!this.state.loading })} style={{ 'display': 'inline-block', 'width': '75%', paddingTop: '1em' }}>
