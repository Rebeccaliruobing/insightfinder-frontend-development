...
import { ModelNameSelection, OperationOptionsSelect } from '../../selections';
...
export default class FileUpdateModel extends Component {
  ...
  handleSubmit(e) {
    ...
    this.setState({ submitLoading: true }, () => {
      apis
        .postUploadUpdate(operation, filenameFilter, modelName, filename)
        .then(resp => {
          if (resp.success) {
              ...
              <div className="six fields fill">
                ...
                <div className="field">
                  <WaringButton
                    ...
                    labelSpan="anomaly result can be used to advise training process by excluding these known anomalous datapoints. Find detailed information and sample data here."
                  />
                ...
                <div className="field">
                  <WaringButton
                    labelStyle={labelStyle}
                    labelTitle="Operation Options"
                    labelSpan="1. Update: update existing models with new training data 2.Revert: undo the previous model update 3.Delete: remove the model from your tool"
                  />
